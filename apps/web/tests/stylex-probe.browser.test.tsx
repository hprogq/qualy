...
//
// This file also held the migration window's cascade contract - that a
// caller's legacy utility beat the compiled value, guarded by the utility
// layer sitting last. That layer is gone, and the case with it.
