...
`messages.ts`/client components 表全灭。(2026-09-15 起键改为 surface 身份,见 docs/browser-public-surface.md;下文描述的 `<plugin>/<Basename>` 派生键已删除。)原文:键 `<plugin>/<Basename>` 由 componentKey 派生,
