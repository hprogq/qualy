...
- [RPC Serializer](/docs/rpc/serializer.md)
- [RPC Handler](/docs/rpc/handler.md)
- [RPC Link](/docs/rpc/link.md)

### OpenAPI

- [OpenAPI Routing](/docs/openapi/routing.md)
- [OpenAPI Input and Output Mapping](/docs/openapi/input-and-output-mapping.md)
- [Bracket Notation](/docs/openapi/bracket-notation.md)
- [OpenAPI Serializer](/docs/openapi/serializer.md)
- [OpenAPI Handler](/docs/openapi/handler.md)
- [OpenAPI Link](/docs/openapi/link.md)
- [OpenAPI Specification](/docs/openapi/specification.md)
- [Scalar (Swagger)](/docs/openapi/scalar.md)

### Contract

- [Procedure Contract](/docs/contract/procedure.md)
- [Router Contract](/docs/contract/router.md)
- [Contract Implementation](/docs/contract/implementation.md)

### Client

- [Server-Side Clients](/docs/client/server-side.md)
- [Client-Side Clients](/docs/client/client-side.md)
- [Client Error Handling](/docs/client/error-handling.md)
- [AsyncIteratorObject in Client](/docs/client/async-iterator-object.md)
- [DynamicLink](/docs/client/dynamic-link.md)

### Adapters

- [Untitled](/docs/adapters/fetch-api.md)
- [Node HTTP Adapter](/docs/adapters/node-http.md)
- [WebSocket Adapters](/docs/adapters/websocket.md)
- [Message Port Adapter](/docs/adapters/message-port.md)
- [React Native Adapter](/docs/adapters/react-native.md)

### Plugins

- [Batch Plugin](/docs/plugins/batch.md)
- [CORS Handler Plugin](/docs/plugins/cors.md)
- [CSRF Guard Plugin](/docs/plugins/csrf-guard.md)
- [Dedupe Plugin](/docs/plugins/dedupe.md)
- [OpenAPI Reference Plugin (Swagger/Scalar)](/docs/plugins/openapi-reference.md)
- [Request Compression Plugin](/docs/plugins/request-compression.md)
- [Request Headers Plugin](/docs/plugins/request-headers.md)
- [Request Limit Plugin](/docs/plugins/request-limit.md)
- [Request Validation Plugin](/docs/plugins/request-validation.md)
- [Response Compression Plugin](/docs/plugins/response-compression.md)
- [Response Headers Plugin](/docs/plugins/response-headers.md)
- [Response Validation Plugin](/docs/plugins/response-validation.md)
- [Rethrow Handler Plugin](/docs/plugins/rethrow.md)
- [Retry After Plugin](/docs/plugins/retry-after.md)
- [Retry Plugin](/docs/plugins/retry.md)
- [Smart Coercion Plugin](/docs/plugins/smart-coercion.md)
- [Timeout Plugin](/docs/plugins/timeout.md)

### Helpers

- [Base64Url Helpers](/docs/helpers/base64url.md)
- [Cookie Helpers](/docs/helpers/cookie.md)
- [Encryption Helpers](/docs/helpers/encryption.md)
- [Form Data Helpers](/docs/helpers/form-data.md)
- [Publisher Helpers](/docs/helpers/publisher.md)
- [Rate Limit Helpers](/docs/helpers/ratelimit.md)
- [Signing Helpers](/docs/helpers/signing.md)

### Integrations

- [AI SDK Integration](/docs/integrations/ai-sdk.md)
- [ArkType Integration](/docs/integrations/arktype.md)
- [Effect Integration](/docs/integrations/effect.md)
- [Evlog Integration](/docs/integrations/evlog.md)
- [Implement oRPC contract with NestJS](/docs/integrations/nest.md)
- [Next.js Integration](/docs/integrations/next.md)
- [OpenTelemetry Integration](/docs/integrations/opentelemetry.md)
- [Pinia Colada Integration](/docs/integrations/pinia-colada.md)
- [Pino Integration](/docs/integrations/pino.md)
- [SWR Integration](/docs/integrations/swr.md)
- [Standard Schema Integration](/docs/integrations/standard-schema.md)
- [TanStack Query Integration](/docs/integrations/tanstack-query.md)
- [tRPC Integration](/docs/integrations/trpc.md)
- [Valibot Integration](/docs/integrations/valibot.md)
- [Zod Integration](/docs/integrations/zod.md)

### Best Practices

- [Dedupe Middleware](/docs/best-practices/dedupe-middleware.md)
- [Monorepo Setup](/docs/best-practices/monorepo-setup.md)
- [No Throw Literal](/docs/best-practices/no-throw-literal.md)
- [Optimizing Server-Side Rendering (SSR) for Fullstack Frameworks](/docs/best-practices/optimizing-ssr.md)

### Advanced

- [Exceeds the Maximum Length Problem](/docs/advanced/exceeds-the-maximum-length-problem.md)
- [Expanding Type Support for OpenAPI Link](/docs/advanced/expanding-type-support-for-openapi-link.md)
- [Publish Client to NPM](/docs/advanced/publish-client-to-npm.md)
- [Scaling Large Projects](/docs/advanced/scaling-large-projects.md)
- [Testing and Mocking](/docs/advanced/testing-and-mocking.md)
- [Validation Customization](/docs/advanced/validation-customization.md)

### Migrations

- [Migrating from tRPC](/docs/migrations/from-trpc.md)
...
- [AsyncIteratorObject (SSE)](/docs/async-iterator-object.md)
- [Binary Data](/docs/binary-data.md)
...
- [Untitled](/shared/any-handler-support-info.md)
- [Untitled](/shared/any-link-support-info.md)
- [Untitled](/shared/common-error-status-map-table.md)
- [Untitled](/shared/router-keys-compatibility-warning.md)
- [Untitled](/shared/standard-server-cors-warning.md)
...
## url: /docs/async-iterator-object.md
...
## url: /docs/openapi/input-and-output-mapping.md
...
## url: /docs/openapi/serializer.md
...
## url: /docs/openapi/specification.md
...
## url: /docs/contract/procedure.md
...
## url: /docs/contract/implementation.md
...
```ts
const listPlanet = implementer.planet
...
## url: /docs/client/async-iterator-object.md
...
## url: /docs/adapters/fetch-api.md
...
## url: /docs/adapters/node-http.md
...
## url: /docs/plugins/csrf-guard.md
...
## url: /docs/plugins/openapi-reference.md
...
## url: /docs/plugins/request-compression.md
...
## url: /docs/plugins/request-limit.md
...
## url: /docs/plugins/response-compression.md
...
## url: /docs/plugins/smart-coercion.md
  ...
  const { messages, sendMessage, status } = useChat({
    transport: {
      async sendMessages(options) {
        return asyncIteratorToUnproxiedDataStream(
          await client.chat(
            {
...
## url: /docs/integrations/arktype.md
...
## url: /docs/integrations/effect.md
...
## url: /docs/integrations/evlog.md
...
export const contract = {
  planet: {
    find: oc.input(z.object({ id: z.number() })).meta(
      piniaColada({
        queryOptions: {
          staleTime: 60 * 1000,
        },
...
export const contract = {
  planet: {
    ...
    update: oc.input(z.object({ id: z.number(), name: z.string() })).meta(
      piniaColada({
        mutationInterceptors: [
...
## url: /docs/integrations/standard-schema.md
...
## url: /docs/integrations/valibot.md
...
## url: /docs/best-practices/optimizing-ssr.md
...
## url: /docs/advanced/expanding-type-support-for-openapi-link.md
...
## url: /docs/advanced/scaling-large-projects.md
...
## url: /docs/advanced/testing-and-mocking.md
...
## url: /docs/advanced/validation-customization.md
...
## url: /shared/any-handler-support-info.md
...
## url: /shared/any-link-support-info.md
...
## url: /shared/common-error-status-map-table.md
...
## url: /shared/router-keys-compatibility-warning.md
...
## url: /shared/standard-server-cors-warning.md
