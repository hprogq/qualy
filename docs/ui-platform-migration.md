...
> **已取代**:本设计描述的是第一次尝试(PrimeReact 11 Styled + StyleX),已被 [ADR 0010](adr/0010-ui-widget-platform.md) 取代,现行设计见 docs/ui-platform-migration-mantine.md。实验分支冻结于 git tag `ui-prime-m4-checkpoint`。本文件作为历史记录保留,不再更新。
